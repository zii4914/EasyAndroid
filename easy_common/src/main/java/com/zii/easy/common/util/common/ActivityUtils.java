...
public final class ActivityUtils {
  ...
  public static boolean isResultOk(int resultCode) {
    return resultCode == RESULT_OK;
  }

  public static boolean isResultOk(int requestCode, int resultCode, int requestTargetCode) {
    return requestCode == requestTargetCode && resultCode == RESULT_OK;
  }

  public static boolean isResultOk(int resultCode, Intent data) {
    return resultCode == RESULT_OK && data != null && data.getExtras() != null;
  }

  public static boolean isResultOk(int requestCode, int resultCode, Intent data, int requestTargetCode) {
    return requestCode == requestTargetCode && resultCode == RESULT_OK && data != null && data.getExtras() != null;
  }
